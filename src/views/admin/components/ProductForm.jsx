...
// Default author names that I used. You can use what you want
const authorOptions = [
  { value: 'Nikita Gill', label: 'Nikita Gill' },
  { value: 'Magdelena Droste', label: 'Magdelena Droste' },
  { value: 'Chitra Banarjee Divakaruni', label: 'Chitra Banarjee Divakaruni' },
  { value: 'Charlotte Bronte', label: 'Charlotte Bronte' }
];

const FormSchema = Yup.object().shape({
  name: Yup.string()
    .required('Book name is required.')
    .max(60, 'Book name must only be less than 60 characters.'),
  author: Yup.string()
  ...
  keywords: Yup.array()
    .of(Yup.string())
    .min(1, 'Please enter at least 1 keyword for this book.'),
  // sizes: Yup.array()
  //   .of(Yup.number())
  ...
  availableColors: Yup.array()
    ...
    .min(1, 'Please add a default color for this book.')
});
...
const ProductForm = ({ product, onSubmit, isLoading }) => {
  ...
  const onSubmitForm = (form) => {
    if (imageFile.image.file || product.imageUrl) {
      ...
      alert('Book thumbnail image is required.');
    }
  };
              ...
              <div className="d-flex">
                ...
                <div className="product-form-field">
                  <CustomCreatableSelect
                    defaultValue={{ label: values.author, value: values.author }}
                    name="author"
                    iid="author"
                    options={authorOptions}
                    disabled={isLoading}
                    placeholder="Select/Create author"
                    label="* Author"
                  />
                </div>
              </div>
