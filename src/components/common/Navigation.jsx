...
import logo from '@/images/LITLIBRAR.jpg';
  ...
  return (
    <nav className="navigation" ref={navbar}>
      ...
      <Link onClick={onClickLink} to="/"><img alt="Logo" src={logo} /></Link>
        {/* <Link onClick={onClickLink} to="/" >LitLibrary</Link> */}
        {/* <img alt="Logo" src={logo} /> */}
      </div>
      <ul className="navigation-menu-main">
        {/* <br></br> */}
        {/* <li><NavLink activeClassName="navigation-menu-active" exact to={ROUTE.HOME}>LitLibrary</NavLink></li> */}
